...
<head>
    ...
    <title>Notre Organigramme - EasyFormers</title>
...
<body>
    ...
    .banner {
        ...
        .banner img {
            ...
            max-width: 1100px; /* Limite la largeur maximale de l'image à 600px pour éviter la distorsion */
    ...
    <img src="Organigramme.png" alt="Image de l'organigramme">
    </div>
